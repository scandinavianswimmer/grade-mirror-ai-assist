...
The public Teacher's Desk preview is live. Release commit [`ded09a6`](https://github.com/scandinavianswimmer/grade-mirror-ai-assist/commit/ded09a610998ae79bfdd5d9fd21d8a464d6b5ab2), tagged `mr-selby-public-queue-2026-08-01`, is deployed as Cloudflare Worker version `ab130f6c-4cc7-449f-bc8e-3f732b735e34`. It serves the interactive fictional review queue, Judge Mode, Privacy, Terms, and Accessibility routes, canonical redirects, self-hosted fonts, and static security headers without loading the protected product bundle.
...
[GitHub Actions run 30736141654](https://github.com/scandinavianswimmer/grade-mirror-ai-assist/actions/runs/30736141654) passed lint, both TypeScript projects, the frozen Deno typecheck for every Edge Function, **295 tests** across 34 test files, the production build, seven-route automated accessibility coverage, deterministic evals, and the calibration gate for the deployed release commit. The same run proved the disabled Supabase deployment path skipped safely. The founder confirmed written organizer approval to proceed with the **Build with Gemini XPRIZE**; the complete ruling remains private evidence and its conditions govern the submission. See [`docs/launch/XPRIZE-SUBMISSION.md`](docs/launch/XPRIZE-SUBMISSION.md) for the exact evidence boundary.
