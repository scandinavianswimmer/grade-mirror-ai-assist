...
const sections: LegalPageSection[] = [
  ...
  { id: 'service', title: 'What Mr Selby provides' },
...
const Terms = () => (
  <LegalPreviewLayout
    ...
    title="Clear expectations for using Mr Selby"
    summary="These preview terms describe the working rules for a teacher-controlled grading assistant. They are candid about the product's limits and the legal details that must be completed before launch."
    sections={sections}
  >
    <LegalSection id="status" title="Status of this preview">
      ...
      <p>
        In these preview terms, “Mr Selby” means the software service being prepared for mrselby.app,
        not an individual person. The name is a personal tribute and does not imply affiliation
        with or endorsement by the teacher who inspired it.
      </p>
      <p>
    ...
    <LegalSection id="service" title="What Mr Selby provides">
      <p>
        Mr Selby is a teacher-facing workspace that can organize assignments and rubrics, extract text from uploaded work, draft annotations and feedback, propose grades, learn from approved examples, and export results for teacher review and use.
      </p>
      <p>
    ...
    <LegalSection id="accounts" title="Accounts and authorized use">
      <p>
        Users should provide accurate account information, protect their credentials, and use Mr Selby only for work they are authorized to perform. A teacher using student material is responsible for confirming that their school or institution permits the chosen workflow.
      </p>
      <p>
    ...
    <LegalSection id="teacher-review" title="Teacher review and AI limits">
      <p>
        Mr Selby produces machine-generated drafts. Outputs can be incomplete, inaccurate, inconsistent, or inappropriate for a particular student. Teachers remain responsible for reviewing the underlying work, applying professional judgment, correcting errors, and making final instructional and grading decisions.
      </p>
      <p>
      ...
      <p>
        Mr Selby should not be used as the sole basis for high-impact disciplinary, admissions, employment, legal, medical, or safety decisions.
      </p>
    </LegalSection>

    <LegalSection id="content" title="Your content and permissions">
      <p>
        The working launch position is that users keep their rights in the assignments, rubrics, student work, and feedback they provide. Users grant the service only the permission needed to host, process, reproduce, and return that content for the services they request.
      </p>
      <p>
      ...
      <p>
        The product&apos;s software, design, branding, and product materials remain separate from user content. The final terms must define both ownership positions precisely and explain what happens to optional, consented personalization examples after consent is changed.
      </p>
    </LegalSection>

    <LegalSection id="acceptable-use" title="Acceptable use">
      <p>Users should not use Mr Selby to:</p>
    ...
    <LegalSection id="plans" title="Plans and billing">
      <p>
        The service may offer free, trial, paid, or institution plans. The price, billing interval, included usage, trial conversion, taxes, and cancellation terms shown at checkout should control for that purchase. Payment processing is handled by the configured payment provider.
      </p>
      <p>
    ...
    <LegalSection id="ending-use" title="Ending use and data">
      ...
      <p>
        Access may need to be restricted when an account creates a security risk, seriously violates the final terms, or has an unpaid plan. Final terms should define notice, appeal where appropriate, and what users can retrieve after access ends.
      </p>
    </LegalSection>
    ...
    <LegalSection id="legal-details" title="Legal details still needed">
      ...
      <p>
        Personal information used with Mr Selby is also described in the <Link to="/privacy" className="font-medium text-foreground underline underline-offset-4 hover:text-primary">Privacy preview</Link>.
      </p>
    </LegalSection>
  </LegalPreviewLayout>
);
